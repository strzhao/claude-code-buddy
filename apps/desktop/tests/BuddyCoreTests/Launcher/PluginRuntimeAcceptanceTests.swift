...
// MARK: - PluginBundledHelloAcceptanceTests （已迁移到 MarketplaceManagerTests）
//
// task 003 (market) 删除 installBundledPlugins + bundled Plugins/ 资源。
// 原 H1/H1b/H2/H3/H3b 五个测试由 MarketplaceManagerTests.seedFromBundle 系列等价覆盖：
//   - seedFromBundle_createsAllPlugins  ← H1
//   - seedFromBundle_idempotent         ← H1b
//   - seedFromBundle_stdinChmod         ← H2
//   - （execute 行为由 PluginDispatcher tests 单独覆盖）
//   - install_pluginNotFound + inspect_listsAll  ← H3b 黑盒契约
